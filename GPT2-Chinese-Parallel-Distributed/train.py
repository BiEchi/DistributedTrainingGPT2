...
def main():
    ...
    parser.add_argument("--local_rank", default=0, type=int, help="no use")
    ...
    if (batch_size == 4):
        lr = args.lr
    elif (batch_size == 2): # 减小学习率使得训练收敛
        lr = args.lr/2
    else:
        print("Invalid batch size! Choose from 2 and 4.")
    ######
